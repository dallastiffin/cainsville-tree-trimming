...
# --- business identity ----------------------------------------------------
BUSINESS      = "Cainsville Tree Service"
CITY          = "Cainsville"
PROVINCE      = "Ontario"
PROVINCE_CODE = "ON"
# Cainsville straddles the municipal line: roughly half is City of Brantford
# and half County of Brant, after annexations in stages through the
# twentieth century. That matters practically - the two municipalities run
# DIFFERENT tree by-laws, so which side of the line a tree stands on can
# change whether a permit is needed. The copy says so rather than guessing.
REGION        = "the County of Brant"
CITY_PROV     = "%s, %s" % (CITY, PROVINCE)

PHONE_DISPLAY = "(226) 546-3847"
PHONE_HREF    = "+12265463847"
EMAIL         = "info@cainsvilletreeservice.com"
...
FORM_CALL_BLURB = ("To speak with someone directly, call {phone}.")

# Browser UI colour. Must match --color-primary in site/style.css and
# theme_color in site/site.webmanifest.
# Cainsville runs near-black charcoal (weight) + leaf green (action). Each of the six Brant County sites takes a
...
CROP_OVERRIDES = {
    ...
    "Front yard Dead Branch Drop.png": ((0.50, 0.50), 1.02),
}
...
DOMAIN = "https://www.cainsvilletreeservice.com"

# The markdown file holding all copy, in this folder.
CONTENT_FILE = "Cainsville-Tree-Trimming-Website-Content.md"
...
TOPBAR_AREA = "Cainsville &amp; east of Brantford"

# The small uppercase line under the business name in the hero masthead.
HERO_PLACE = "Cainsville, Ontario · on the Grand"

# Footer map. The pb= form, which needs no API key.
MAP_EMBED = ("https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d46000!2d-80.1966!3d43.1453!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sca!4v1780000000006!5m2!1sen!2sca")

# Contact form placeholders.
PHONE_PLACEHOLDER   = "226-000-0000"
MESSAGE_PLACEHOLDER = ("Tell us which tree it is, roughly how tall it stands, what is underneath it, and what is wrong with it. Please mention it if the tree is near the river bank.")
...
{_hero_picture("")}
  ...
  <div class="hero__scrim hero__scrim--editorial" aria-hidden="true"></div>
  <div class="container hero__inner">
  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <nav aria-labelledby="footer-guides-heading">
        ...
        <ul class="footer-list">
          <li><a href="tree-risk-across-ontario-regions.html">Regional Guide</a></li>
          <li><a href="storm-season-pricing-timelines.html">Seasonal Pricing Guide</a></li>
          <li><a href="property-overhaul-planning.html">Property Project Planning</a></li>
          <li><a href="protecting-new-work-during-tree-removal.html">Protecting Your Property</a></li>
        </ul>
      </nav>
...
PAGE_PHOTOS = [
  ...
  ("Front yard Dead Branch Drop.png", HERO_IMG, (4,3), [800,1200],
   f"Cut section flown out over the lawn on a crane sling in {CITY}"),
  ("Front yard Dead Branch Drop.png", "og-image", (1200,630), [1200],
   f"{BUSINESS} - tree trimming, tree removal and storm damage cleanup"),
  ("Tree Climber Cutting Branch 1.png", "service-tree-trimming-and-pruning", (16,10), [640,960],
   "Climber cutting a limb back above a roofline"),
  ("Big Dead Branch.png", "service-dead-branch-removal", (16,10), [640,960],
   "Climber on a long heavy limb reaching over a house"),
  ("Large Broken Branch.png", "service-emergency-storm-damage-cleanup", (16,10), [640,960],
   "Two-man crew rigging down a limb that failed at the union"),
  ("Grinding 1.png", "service-tree-removal", (16,10), [640,960],
   "Grinder cutting into a stump on a suburban front lawn"),
  ("Trimming Small Tree from Ground.png", "service-crown-thinning-and-canopy-reduction", (16,10), [640,960],
   "Pole saw work on a small ornamental tree in a front garden"),
  ("Hollow Dead Branc.png", "service-tree-cabling-and-bracing", (16,10), [640,960],
   "Hollow dead trunk section lying on the grass beside a willow"),
  ("Grinding 7.png", "service-stump-grinding-and-removal", (16,10), [640,960],
   "Grinder walked through a side gate to reach a back garden stump"),
  ("Wood Chipper.png", ABOUT_IMG, (4,3), [800,1200],
   "Crew feeding brush into the chipper and clearing the site behind them"),
  ("Dead Branch 2.png", SERVICES_IMG, (4,3), [800,1200],
   "Dead limbs down at the foot of a trunk with an open decay cavity"),
]

GALLERY_PHOTOS = [
  ("Lowering Large Branch.png", "cainsville-1",
   "Crane lifting a cut limb clear of a lawn"),
  ("Grinding 2.png", "cainsville-2",
   "Grinder working a stump in a fenced back garden"),
  ("Man in Harness 1.png", "cainsville-3",
   "Climber moving out along a limb inside a dense summer canopy"),
  ("Garage.png", "cainsville-4",
   "Storm-thrown tree resting across the roof of a detached garage"),
]
...
<!-- ============================= QUOTE BAND =============================
     ...
     a full-width band of its own, placed directly beneath the hero so the
     first thing under the photograph is the way to make contact. Its fields
     get more horizontal space than a narrow sidebar allowed. -->
...
# ============================================================================
GUIDE_PAGES = [
    ("tree-risk-across-ontario-regions.html", COPY_BLOCK_INDEX + 1, "Regional Guide"),
    ("storm-season-pricing-timelines.html", COPY_BLOCK_INDEX + 2, "Seasonal Pricing Guide"),
    ("property-overhaul-planning.html", COPY_BLOCK_INDEX + 3, "Property Project Planning"),
    ("protecting-new-work-during-tree-removal.html", COPY_BLOCK_INDEX + 4, "Protecting Your Property"),
]
