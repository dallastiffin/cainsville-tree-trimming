/**
 * Cainsville Tree Service — website lead handler
 * ========================================================
 *
 ...
 *  info@cainsvilletreeservice.com only works once email forwarding is
 ...
 */
function doGet() {
  return reply(true, 'Cainsville Tree Service lead endpoint is running.');
}
...
function sendAlert(data) {
  ...
  MailApp.sendEmail({
    to: NOTIFY_EMAIL,
    subject: 'New estimate request: ' + (data.service || 'Cainsville Tree Service'),
    body: lines.join('\n'),
