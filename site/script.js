...
(function () {
  ...
  /* ==================================================================
     ...
     previewing locally.
     ================================================================== */
  /* Cainsville's own Apps Script web app. NOT YET CREATED.

     This project was generated from a template that had been copied from a
     DEPLOYED site, and this field arrived carrying that site's live /exec URL.
     It would have posted every Cainsville lead into somebody else's spreadsheet
     with no visible error at all. It has been cleared. This is the third town
     that has happened to, so: if you copy this project to start another city,
     CLEAR THIS FIRST and grep the whole folder for AKfycb before you push.

     Replace the placeholder below with the /exec URL from the Cainsville leads
     spreadsheet once that Apps Script is deployed. It must be Cainsville's own
     endpoint - a sibling city's URL will silently misfile every lead.

     After changing this value you MUST re-run build.py. _headers caches this
     file hard at the edge and build.py stamps a content hash onto the script
     URL, so without the rebuild the new endpoint never reaches anyone who has
     already visited. */
  var SHEET_ENDPOINT = 'https://script.google.com/macros/s/AKfycby0EH79Ggy2SFJ8KJ8ZoAWucio-S68-rAHKyJN9tuQ6pMOS_w0sDkVt3_fd68KXr1NK3g/exec';
